...
gcc TwoRegions_baseline.c WatermanFun.c StateIO.c -lm -O3 -o ../bin/TwoRegions_baseline.out
...
g++ -std=c++11 FakeChromosomeGenerator.cpp WatermanFun.c StateIO.c -O3 -o ../bin/FakeChromosomeGenerator.out
gcc -O3 DatabaseSearch_baseline1.c WatermanFun.c StateIO.c -lm -o ../bin/DatabaseSearch_baseline1.out
gcc -O3 DatabaseSearch_baseline2.c WatermanFun.c StateIO.c -lm -o ../bin/DatabaseSearch_baseline2.out
gcc -O3 DatabaseSearch_baseline3.c WatermanFun.c StateIO.c -lm -o ../bin/DatabaseSearch_baseline.out
