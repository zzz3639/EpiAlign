...
${ExePath}CutFolder_Init.sh ${ARRAY0[10]}ParaCut.temp
${ExePath}cut_sseq.out ${ARRAY0[10]}ParaCut.temp
...
for i in ${Names[@]}; do
    ...
    ${ExePath}DatabaseSearch.out ${ARRAY0[10]}PathSearch.temp ${ARRAY0[10]}ParaSearch.temp ${ARRAY0[11]} >${ARRAY0[10]}${i}.score
done
